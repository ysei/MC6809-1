...
class Test6809_TFR < BaseCPUTestCase
    def test_TFR_A_B
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0x12)
        assertEqualHexByte(@cpu.accu_b.get(), 0x12)
    end
    ...
    def test_TFR_B_A
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0x34)
        assertEqualHexByte(@cpu.accu_b.get(), 0x34)
    end
    ...
    def test_TFR_X_U
        ...
        assertEqualHexWord(@cpu.index_x.get(), 0x1234)
        assertEqualHexWord(@cpu.user_stack_pointer.get(), 0x1234)
    end
    ...
    def test_TFR_CC_X
        ...
        assertEqualHexByte(@cpu.cc.get(), 0x34)
        assertEqualHexWord(@cpu.index_x.get(), 0xff34)
    end
    ...
    def test_TFR_CC_A
        ...
        assertEqualHexByte(@cpu.cc.get(), 0x89)
        assertEqualHexByte(@cpu.accu_a.get(), 0x89)
    end
    ...
    def test_TFR_Y_B
        ...
        assertEqualHexWord(@cpu.index_y.get(), 0x1234)
        assertEqualHexByte(@cpu.accu_b.get(), 0x34)
    end
    ...
    def test_TFR_undefined_A
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0xff)
    end
end
...
class Test6809_EXG < BaseCPUTestCase
    def test_EXG_A_B
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0x12)
        assertEqualHexByte(@cpu.accu_b.get(), 0xab)
    end
    ...
    def test_EXG_A_X
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0x34)
        assertEqualHexWord(@cpu.index_x.get(), 0xff56)
    end
    ...
    def test_EXG_A_CC
        ...
        assertEqualHexByte(@cpu.accu_a.get(), 0xe2)
        assertEqualHexByte(@cpu.cc.get(), 0x1f)
    end
    ...
    def test_EXG_undefined_to_X
        ...
        assertEqualHexWord(@cpu.index_x.get(), 0xffff)
    end
end
