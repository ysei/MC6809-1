...
class Test6809_BranchInstructions < BaseCPUTestCase
    ...
    def test_BCC_no
        ...
        assertEqualHex(@cpu.program_counter.value, 0x1002)
    end
    ...
    def test_BCC_yes
        ...
        assertEqualHex(@cpu.program_counter.value, 0xff6)
    end
    ...
    def test_LBCC_no
        ...
        assertEqualHex(@cpu.program_counter.value, 0x1004)
    end
    ...
    def test_LBCC_yes
        ...
        assertEqualHex(@cpu.program_counter.value, 0x17e8)
    end
...
#            print sprintf("%s - $%04x", @cpu.get_cc_info(), @cpu.program_counter)
